...
import bubbleLoading from '../join/images/bubbleLoading.gif'
...
const Chat = ({ location }) => {
  ...
  if (loading) {
    ...
    <img  src={bubbleLoading} alt="Loading..."   />
    </div>;
  }
  return (
    <>
      <button className={Styles.usersname} onClick={getusers}>
        <img alt="" src={usersicon} width="30px" height="30px" />
      </button>
